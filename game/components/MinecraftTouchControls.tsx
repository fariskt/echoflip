  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-20 select-none overflow-hidden touch-none">
      ...
      <div
        ...
        className="pointer-events-auto absolute right-0 top-16 bottom-20 w-2/3 touch-none z-10 opacity-0"
      />
      ...
      <div className="pointer-events-auto absolute bottom-4 left-4 z-40 flex items-center justify-center">
        <div
          ...
          className="relative w-32 h-32 rounded-full bg-slate-950/75 border-2 border-emerald-500/60 backdrop-blur-md flex items-center justify-center shadow-2xl active:border-emerald-400 touch-none"
        >
          ...
          <div className="absolute inset-0 grid grid-cols-3 grid-rows-3 p-1 pointer-events-none opacity-40">
            <div />
            <div className="flex items-center justify-center font-bold text-emerald-400 text-[10px]">▲</div>
            <div />
            <div className="flex items-center justify-center font-bold text-emerald-400 text-[10px]">◄</div>
            <div className="flex items-center justify-center text-[8px] text-slate-400 font-mono">MOVE</div>
            <div className="flex items-center justify-center font-bold text-emerald-400 text-[10px]">►</div>
            <div />
            <div className="flex items-center justify-center font-bold text-emerald-400 text-[10px]">▼</div>
            <div />
          ...
          <div
            className={`w-12 h-12 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 border-2 border-white/90 shadow-lg flex items-center justify-center transition-transform duration-75 ${
          ...
          >
            <div className="w-4 h-4 rounded-full bg-white/40 border border-white/60" />
          </div>
        </div>
      </div>
      ...
      <div className="pointer-events-auto absolute bottom-4 right-4 z-40 flex flex-col items-end gap-2.5 touch-none">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`w-11 h-11 rounded-xl border flex flex-col items-center justify-center shadow-xl backdrop-blur-md active:scale-95 transition ${
          ...
          <button
            ...
            className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-600 to-teal-500 hover:from-emerald-500 hover:to-teal-400 active:scale-95 text-white font-bold border-2 border-emerald-300 shadow-2xl flex flex-col items-center justify-center space-y-0.5"
          >
            <Hammer className="w-5 h-5 text-white" />
            <span className="text-[8px] font-black tracking-wide text-emerald-100 uppercase">ACTION</span>
          </button>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="w-12 h-12 rounded-xl bg-slate-900/90 border border-slate-700 active:bg-emerald-600 text-slate-200 font-bold flex flex-col items-center justify-center shadow-lg backdrop-blur-md"
          >
            <ArrowDown className="w-4 h-4 text-emerald-400" />
            <span className="text-[7px] text-slate-400 font-mono">DOWN</span>
          </button>
          ...
          <button
            ...
            className="w-13 h-13 rounded-xl bg-slate-900/90 border border-slate-700 active:bg-emerald-600 text-slate-200 font-bold flex flex-col items-center justify-center shadow-lg backdrop-blur-md"
          >
            <ArrowUp className="w-5 h-5 text-emerald-400" />
            <span className="text-[8px] text-emerald-300 font-bold font-mono">JUMP</span>
          </button>
        </div>
      </div>
    </div>
